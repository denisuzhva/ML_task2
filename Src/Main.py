...
if DATASET == 'netflix':
    ...
    DATASET_NAME = 'netflix_dataset_index'  # name of the dataset
elif DATASET == 'movielens_small':
    NUM_FEATURES = 610 + 193609
    NUM_SAMPLES = 100836
    DATASET_NAME = 'movielens_small_dataset_index'

NUM_FACTORS = 5 # number of factors (aka k)
LR = 1 * 1e-2   # learning rate constant
BATCH_LIST = [2000] # batches to test
#BATCH_LIST = [1600]
...
if __name__ == '__main__':
    ...
    dataset = np.load('../Dataset/{}/{}.npy'.format(DATASET, DATASET_NAME))
