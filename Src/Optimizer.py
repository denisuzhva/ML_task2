...
def optimize(model, train_data, train_labels, batch_size, learning_rate):
    ...
    train_data, train_labels = dt.shuffle(train_data, train_labels, batch_size)
    ...
    for batch_iter in range(batches_per_fold):
        ...
        model.updateParameters(train_dataset_batch, train_labels_batch, batch_size, learning_rate)
